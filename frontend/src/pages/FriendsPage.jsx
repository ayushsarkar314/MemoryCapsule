...
const FriendsPage = () => {
  ...
  return (
    <div className="lp-root create-shader-bg" style={{ minHeight: '100vh', position: 'relative' }}>
      ...
      <div className="container page-content" style={{ position: 'relative', zIndex: 10, paddingTop: '100px', paddingBottom: '64px', maxWidth: '960px', margin: '0 auto' }}>
        ...
        <div style={{ marginBottom: '24px', display: 'inline-flex', background: 'rgba(237, 231, 227, 0.7)', backdropFilter: 'blur(12px)', padding: '4px', borderRadius: '9999px', border: '1px solid rgba(255, 255, 255, 0.5)' }}>
          <button
            ...
            style={{
              ...
              borderRadius: '9999px',
              border: 'none',
              background: activeTab === 'friends' ? 'linear-gradient(135deg, #ff7ab3 0%, #ff4a90 100%)' : 'transparent',
              color: activeTab === 'friends' ? '#fff' : '#4f4447',
              fontFamily: 'Manrope, sans-serif',
              fontWeight: activeTab === 'friends' ? 700 : 600,
              fontSize: '14px',
              cursor: 'pointer',
              boxShadow: activeTab === 'friends' ? '0 6px 24px rgba(255,74,140,0.24)' : 'none',
          ...
          <button
            ...
            style={{
              ...
              borderRadius: '9999px',
              border: 'none',
              background: activeTab === 'requests' ? 'linear-gradient(135deg, #ff7ab3 0%, #ff4a90 100%)' : 'transparent',
              color: activeTab === 'requests' ? '#fff' : '#4f4447',
              fontFamily: 'Manrope, sans-serif',
              fontWeight: activeTab === 'requests' ? 700 : 600,
              fontSize: '14px',
              cursor: 'pointer',
              boxShadow: activeTab === 'requests' ? '0 6px 24px rgba(255,74,140,0.24)' : 'none',
              transition: 'all 0.25s',
              display: 'flex',
              alignItems: 'center',
              gap: '8px'
